# Changelog — jw-agenda skill set

All notable changes to the **jw-agenda** skill set (the 5 modular skills) are documented in this file. The `jw-agenda-v2` skill is versioned separately in [../jw-agenda-v2/doc/CHANGELOG.md](../jw-agenda-v2/doc/CHANGELOG.md).

The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/), and this skill set follows [Semantic Versioning](https://semver.org/spec/v2.0.0.html). Git tags for this set are prefixed `jw-agenda-vX.Y.Z`.
